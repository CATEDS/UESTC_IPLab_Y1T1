/*
    This function is designed to get the MOBILE form of input, transform it into EASY form
    and then store it in the correct position of the array. And if the keyboard is filled, we
    should end the game.
*/
...
void Put_X(void) {   // For the MOBILE edition of the fomula
    while (true) {
        ...
        PosiInput -= 1;
        /*
            This formula can transform the MOBILE style input to EASY style.
        */
        if (

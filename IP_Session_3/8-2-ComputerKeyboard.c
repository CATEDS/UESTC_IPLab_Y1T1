/*
    This function is designed to get the COMPUTER KEYBOARD form of input, transform it into EASY form
...
void Put_X(void) {   // For the COMPUTER KEYBOARD edition of the fomula
    while (true) {

...
int main(void) {                                                            // Define the main() function
    int BestScore = -1;                                                     // Init the variable to store the best score of the game
    for (int i=0; i<4; i++) {                                               // Doing the guess game for 4 times
        ...
        if (BestScore == -1) BestScore = Guesses;                           // Init the best score if it's the first game
        else BestScore = (BestScore>Guesses)?Guesses:BestScore;             // Refresh the best score if user achieves a lower score
